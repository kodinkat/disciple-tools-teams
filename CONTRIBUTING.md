...
Note: rules for PHPCS are located in the `phpcs.xml` file. We sometimes update the rule list as PHPCS updates. We’ll update the [teams plugin](https://github.com/DiscipleTools/disciple-tools-teams) `phpcs.xml`, you might want to look there to get the latest version.

### GitHub and Commits
For new plugins copy our [teams plugin](https://github.com/DiscipleTools/disciple-tools-teams).
