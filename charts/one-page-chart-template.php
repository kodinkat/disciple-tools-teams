...
class Disciple_Tools_Teams_Chart_Template extends DT_Metrics_Chart_Base
{
    public $base_slug = 'disciple-tools-teams-metrics'; // lowercase
    public $base_title = "Teams Metrics";
